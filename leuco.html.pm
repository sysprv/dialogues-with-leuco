...
◊h1{Dialogues with Leucò}
◊h2{Cesare Pavese}

◊section[#:id "foreword"]{
  ◊h1{Foreword}
  ◊p[#:class "intro"]{
Had it been possible, I would gladly have done without all
...
later pursued with implacable hatred.
  }
◊; page-number 2
  ...
  ◊ixion{
The law has no power here, Nephele. Here the law is the
glacier, the storm, the darkness. And when at last the
weather clears and you drift softly toward the peak, it's no
time then to be thinking about the law.
  }
  ◊cloud{
There is a law, Ixion, which didn't exist before. A
stronger hand now masses the clouds.
  }
  ◊ixion{
That hand doesn't reach here. Look, the weather's clear,
...
the mountains. We're used to all this.
  }
  ◊cloud{
Much has changed on the mountains. Pelion knows
it. Ossa and Olympus know it. Wilder mountains know it
too.
  }
  ◊ixion{What has changed on the mountains, Nephele?}
  ◊cloud{
Not the sun, not the rain, Ixion. Man's fate has
...
hold the world. There is a law, Ixion.
  }
  ◊ixion{What law?}
  ◊cloud{You already know. Your fate, the limit imposed
upon you—
  }
◊; page-number 3
  ◊ixion{
I hold my fate in my fist, Nephele. What has changed?
...
fatigue and death?
  ...
  ◊cloud{
That's not it, Ixion. You can still do all that, and
...
You're afraid of me?
  ...
  ◊cloud{
I'll be here on the mountain, here and everywhere.
...
your only salvation.
  ...
  ◊cloud{
Yes, I'm afraid. I've seen the mountain peaks. But
...
monsters.
  ...
  ◊ixion{Who says so?}
  ◊cloud{
Don't defy that hand, Ixion. It is fate. I've seen
...
from you, like a blessing refused. Do you know this?
  }
  ◊ixion{
You've told me so before. What does it matter? We'll
live more intensely.
  }
  ◊cloud{You can't be serious. You don't know the immortals.}
  ◊ixion{I want to know them, Nephele.}
  ◊cloud{
Ixion, you think they're presences like us, like Night,
...
forever.
  ...
  ◊cloud{
No, Ixion. They will turn you into a kind of shadow,
a shade that wants to live but never dies.
  }
  ◊ixion{Have you seen them, these gods of yours?}
  ◊cloud{
I have seen them . . . Oh Ixion, you don't know
what you're asking.
  }
  ◊ixion{
I've seen some of them too, Nephele. I don't find them
so terrible.
  }
  ◊cloud{
I knew it. Your fate is sealed. Which one did you
see?
  }
  ◊ixion{
How could I tell? It was a young man. He was walking
...
like you.
  ...
  ◊cloud{Is he the only one you saw?}
  ◊ixion{
I saw him again in a dream, with the goddesses. I seemed
...
laughed at the ridiculous monsters—
  }
  ◊cloud{
O Ixion, Ixion, your fate is sealed! Now you know
what has changed up there above the mountains. And
you've changed too. And you think you're more than a man.
  }
  ◊ixion{
I tell you, Nephele, that you're like them. Why shouldn't
I admire them, at least in a dream?
  }
  ◊cloud{
Fool, you can't stop at dreams. You'll climb up to
them, aspire to them. You'll do something terrible. Then
that death of theirs will come.
  }
  ◊ixion{Tell me all the goddesses' names.}
  ◊cloud{
You see? Dreaming isn't enough for you now.
...
you.
  ...
  ◊ixion{
I had another dream last night. You were in it too,
...
with impunity.
  ...
  ◊ixion{
Not even to the Goddess of the Oaks, the Lady of the
Peaks?
  }
  ◊cloud{
...
◊; page-number 46
  ...
  ◊hermes{
Listen, Meleager. You're dead now. The flames, the
...
you now.
  ...
  ◊meleager{
I don't see anything. What does it matter? I'm an
...
knew.
  ...
  ◊hermes{
Do you think any man in the world has ever known
anything else?
  }
  ◊meleager{
I don't know. But I've heard of lives that were lived
...
marked with the sign of strange destinies.
  }
◊; page-number 47
  ◊hermes{
Everyone of them had a mother, Meleager. And labors
to perform. And the same death awaited them all. They all
died of another's passion. None of them was his own master,
or knew anything else.
  }
  ◊meleager{
A mother . . . None of them had a mother like mine.
...
That's what hurts. An enemy is nothing.
  }
  ◊hermes{
You're strange, you mortals. The thing you already know
amazes you. That an enemy is nothing is obvious. He has
a mother too, like anybody else. So why can't you accept
the knowledge that your life lies in her hands?
  }
  ◊meleager{
Hermes, we hunters have an agreement. When we
climb the mountain, each man helps the other. Each holds
the other's life in his hands; he never betrays his friend.
  }
  ◊hermes{
Fool, a friend is always betrayed . . . But that's not it.
...
passion, smouldering on in you. What are you but her flesh and blood?
  }
  ◊meleager{
It was her eyes, Hermes. You have to have seen those
...
the brand as it burns, becomes unbearable.
  }
◊; page-number 48
  ◊hermes{
You know this too, and it surprises you, Meleager? The
...
marked him from birth with the sign of the fire.
  }
  ◊meleager{Has anyone else had my fate, Hermes?}
  ◊hermes{
Everyone, Meleager. Everyone. The same death awaits
them all. They all die of another's passion. In every man's
flesh and blood, his mother rages. True, many men are
cowards, worse cowards than you.
  }
  ◊meleager{I was no coward, Hermes.}
  ◊hermes{
I speak to you as a shade, not as a mortal. So long as a
man doesn't know, he's brave.
  }
  ◊meleager{
I'm no coward now, not here, seeing what I see. I
know many things now. But I don't believe that she—the
young she—knew anything about those eyes.
  }
  ◊hermes{She didn't know, Meleager. She ◊em{was} those eyes.}
  ◊meleager{
Atalanta . . . Will she become a mother too? Could
she stare at the fire? Atalanta?
  }
  ◊hermes{
See if you can remember what she said to you, the night
when you killed the boar.
  }
  ◊meleager{
That night. The night of the pact. I haven't forgotten
...
way the other wouldn't be tempted by anger.
  }
  ◊hermes{And what did Atalanta say?}
  ◊meleager{
I remember clearly, Hermes. "Son of Althaea", she
...
though asking for forgiveness.
  ...
  ◊hermes{
Meleager, no mortal succeeds in thinking of his mother
as a girl. But don't you think the person who could say such
words would be capable of staring at the fire? It was old
Althaea who killed you, for a blood-price.
  }
  ◊meleager{
Hermes, all this is my fate. But surely there must have
been mortals who lived full lives, men whose lives didn't lie
in somebody else's hands . . .
  }
  ◊hermes{
Do you know of any, Meleager? They would be gods.
...
Meleager, you were lucky.
  }
  ◊meleager{
But not even to see my own children, barely to know
my own bed . . .
  }
  ◊hermes{
You've been lucky. Your children will not be born. Your
bed is empty. Your friends go hunting as they did before
you existed. You are a shade, a nothing.
  }
  ◊meleager{And Atalanta? What about her?}
  ◊hermes{
The house is empty as it used to be when night was
